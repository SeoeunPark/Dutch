...
class Menuinsert:
    def __init__(self, menu):
        ...
        # 메뉴 입력
        self.menuText = Label(self.menu, text='어떤 메뉴를 먹었나요?', width=20, bg="white", font=fontq, fg='#ff7878')
        self.menuText.place(x=100, y=140)

        self.inputMenu = Entry(self.menu, width=80, font=font, relief="groove", highlightthickness=2,
                               highlightbackground="#8294cd")
        ...
        # 단체메뉴
        self.groupmenu = Entry(self.menu, width=55, font=font, relief="groove", bg='white', fg='black',
                               highlightthickness=1, highlightbackground="#8294cd")
        ...
        self.rd1 = Radiobutton(self.menu, text="100", bg="white", font=fontq, fg='#ff7878', value=1,
                               variable=self.RadioVariety_1)
        self.rd1.place(x=100, y=600)

        self.rd2 = Radiobutton(self.menu, text="1000", bg="white", font=fontq, fg='#ff7878', value=2,
                               variable=self.RadioVariety_1)
        self.rd2.place(x=200, y=600)

        self.rd3 = Radiobutton(self.menu, text="10000", bg="white", font=fontq, fg='#ff7878', value=3,
                               variable=self.RadioVariety_1)
        self.rd3.place(x=300, y=600)

        # 저장 버튼
        self.saveButton = Button(self.menu, width=30, text='G O !', repeatdelay=20, bg='#ff7878',
                                 font=fontq, fg="white", command=self.to_receipt)  # command=self.to_receipt,
